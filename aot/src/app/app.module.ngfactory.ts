...
import * as import7 from '../../../src/app/childModule/child.module';
...
import * as import31 from './childModule/child.component.ngfactory';
import * as import32 from './error/pagenotfound.component.ngfactory';
...
import * as import40 from '../../../src/app/childModule/child.component';
import * as import41 from '../../../src/app/error/pagenotfound.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _ChildModule_6:import7.ChildModule;
  ...
  __Location_43:import25.Location;
  __UrlSerializer_44:import26.DefaultUrlSerializer;
  __RouterOutletMap_45:import27.RouterOutletMap;
  __NgModuleFactoryLoader_46:import28.SystemJsNgModuleLoader;
  __Router_47:any;
  ...
  constructor(parent:import30.Injector) {
    super(parent,[
      import31.ChildComponentNgFactory,
      import32.PageNotFoundComponentNgFactory,
      import33.AppComponentNgFactory
    ]
    ,[import33.AppComponentNgFactory]);
  }
  get _LOCALE_ID_8():any {
    if ((this.__LOCALE_ID_8 == null)) { (this.__LOCALE_ID_8 = import3._localeFactory(this.parent.get(import34.LOCALE_ID,(null as any)))); }
  ...
  get _RootRenderer_25():any {
    if ((this.__RootRenderer_25 == null)) { (this.__RootRenderer_25 = import39._createConditionalRootRenderer(this._DomRootRenderer_23,this.parent.get(import39.NgProbeToken,(null as any)),this._NgProbeToken_24)); }
  ...
  get _AnimationQueue_28():import18.AnimationQueue {
    if ((this.__AnimationQueue_28 == null)) { (this.__AnimationQueue_28 = new import18.AnimationQueue(this.parent.get(import38.NgZone))); }
  ...
  get _ROUTES_40():any[] {
    if ((this.__ROUTES_40 == null)) { (this.__ROUTES_40 = [
        [{
          path: 'child',
          component: import40.ChildComponent,
      ...
      [
        ...
        {
          path: 'child',
          component: import7.ChildModule,
          data: {title: 'Heroes List'}
        }
        ,
        {
          path: '**',
          component: import41.PageNotFoundComponent
        }
  ...
  get _LocationStrategy_42():any {
    if ((this.__LocationStrategy_42 == null)) { (this.__LocationStrategy_42 = import6.provideLocationStrategy(this.parent.get(import42.PlatformLocation),this.parent.get(import43.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_41)); }
    return this.__LocationStrategy_42;
  }
  get _Location_43():import25.Location {
    if ((this.__Location_43 == null)) { (this.__Location_43 = new import25.Location(this._LocationStrategy_42)); }
    return this.__Location_43;
  }
  get _UrlSerializer_44():import26.DefaultUrlSerializer {
    if ((this.__UrlSerializer_44 == null)) { (this.__UrlSerializer_44 = new import26.DefaultUrlSerializer()); }
    return this.__UrlSerializer_44;
  }
  get _RouterOutletMap_45():import27.RouterOutletMap {
    if ((this.__RouterOutletMap_45 == null)) { (this.__RouterOutletMap_45 = new import27.RouterOutletMap()); }
    return this.__RouterOutletMap_45;
  }
  get _NgModuleFactoryLoader_46():import28.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_46 == null)) { (this.__NgModuleFactoryLoader_46 = new import28.SystemJsNgModuleLoader(this._Compiler_15,this.parent.get(import28.SystemJsNgModuleLoaderConfig,(null as any)))); }
    return this.__NgModuleFactoryLoader_46;
  }
  get _Router_47():any {
    if ((this.__Router_47 == null)) { (this.__Router_47 = import6.setupRouter(this._ApplicationRef_14,this._UrlSerializer_44,this._RouterOutletMap_45,this._Location_43,this,this._NgModuleFactoryLoader_46,this._Compiler_15,this._ROUTES_40,this._ROUTER_CONFIGURATION_41,this.parent.get(import44.UrlHandlingStrategy,(null as any)),this.parent.get(import45.RouteReuseStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_53():any {
    if ((this.__ROUTER_INITIALIZER_53 == null)) { (this.__ROUTER_INITIALIZER_53 = import6.initialRouterNavigation(this._Router_47,this._ApplicationRef_14,this._RouterPreloader_51,this._ROUTER_CONFIGURATION_41)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_4 = import6.provideForRootGuard(this.parent.get(import46.Router,(null as any)));
    this._RouterModule_5 = new import6.RouterModule(this._ROUTER_FORROOT_GUARD_4);
    this._ChildModule_6 = new import7.ChildModule();
    ...
    this._ApplicationRef__13 = new import11.ApplicationRef_(this.parent.get(import38.NgZone),this.parent.get(import47.Console),this,this._ErrorHandler_10,this,this._ApplicationInitStatus_11,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_12);
    this._NoPreloading_49 = new import29.NoPreloading();
    this._PreloadingStrategy_50 = this._NoPreloading_49;
    this._RouterPreloader_51 = new import29.RouterPreloader(this._Router_47,this._NgModuleFactoryLoader_46,this._Compiler_15,this,this._PreloadingStrategy_50);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import7.ChildModule)) { return this._ChildModule_6; }
    ...
    if ((token === import51.RootRenderer)) { return this._RootRenderer_25; }
    if ((token === import17.DomSanitizer)) { return this._DomSanitizer_26; }
    if ((token === import52.Sanitizer)) { return this._Sanitizer_27; }
    ...
    if ((token === import57.ROUTES)) { return this._ROUTES_40; }
    ...
    if ((token === import25.Location)) { return this._Location_43; }
    if ((token === import26.UrlSerializer)) { return this._UrlSerializer_44; }
    if ((token === import27.RouterOutletMap)) { return this._RouterOutletMap_45; }
    if ((token === import58.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_46; }
    if ((token === import46.Router)) { return this._Router_47; }
    if ((token === import59.ActivatedRoute)) { return this._ActivatedRoute_48; }
    ...
    if ((token === import35.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_54; }
